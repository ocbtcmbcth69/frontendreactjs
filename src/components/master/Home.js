...
export default function Home({ setCartNumber }) {
    return (
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <figure class="card card-product-grid">
                                ...
                                <figcaption class="info-wrap border-top">
                                    ...
                                    <button class="btn btn-primary" onClick={() => setCartNumber((n) => n + 1)}>Add to cart</button>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <article>
                                <a href="#" class="img-wrap">
                                    <img class="rounded w-100" src="" height="160" />
                                </a>
                                <div class="mt-2">
